      ...
      <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li aria-current="page">
          <div className="flex items-center">
            ...
            <span className="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">View Profile</span>
          </div>
        </li>
      </ol>
    </nav>
      ...
      <div className="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
        <div className="space-y-4">
          <div className="flex space-x-4">
            <img  className="h-16 w-16 rounded-lg cursor-pointer" src={userStore.user.profilePic} alt="Helene avatar" />
            <p onClick={handleProfileChanger} title='Update Your Profile' className='cursor-pointer'><FaCamera /></p>
            <div>
              ...
              <h2 className="flex items-center text-xl font-bold leading-none text-gray-900 dark:text-white sm:text-2xl">{userStore.user.name}</h2>
            </div>
          </div>
          <dl className>
            <dt className="font-semibold text-gray-900 dark:text-white">Email Address</dt>
            <dd className="text-gray-500 dark:text-gray-400">{userStore.user.email}</dd>
          </dl>
          <dl>
        ...
        <div className="space-y-4">
          <dl>
            ...
            <dd className="text-gray-500 dark:text-gray-400">{userStore.user.phoneNumber}</dd>
          </dl>
    ...
    {/* <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 md:p-8">
      ...
      <div className="flex flex-wrap items-center gap-y-4 border-b border-gray-200 pb-4 dark:border-gray-700 md:pb-5">
        ...
        <div className="w-full sm:flex sm:w-32 sm:items-center sm:justify-end sm:gap-4">
          <button id="actionsMenuDropdownModal10" data-dropdown-toggle="dropdownOrderModal10" type="button" className="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 md:w-auto">
            Actions
